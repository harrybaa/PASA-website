...
function times_square_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Right', 'times-square' ),
		'id'            => 'sidebar-right',
		'description'   => __( 'Appears in the footer section of the right.', 'times-square' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s"><div class="panel panel-'.esc_html($times_square_settings['theme-widget-header-bg']).'">',		# panel-primary
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Left', 'times-square' ),
		'id'            => 'sidebar-left',
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Header', 'times-square' ),
		'id'            => 'sidebar-header',
		'description'   => __( 'Main sidebar that appears on the top.', 'times-square' ),
		'before_widget' => '<aside class="col-md-3">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>',
	) );
	register_sidebar( array(
		...
		'id'            => 'sidebar-footer',
		'description'   => __( 'Appears in the footer section of the footer.', 'times-square' ),
		'before_widget' => '<aside class="col-md-3">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2>',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Content', 'times-square' ),
		'id'            => 'sidebar-content',
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Header Only Home', 'times-square' ),
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar Content Only Home', 'times-square' ),
		'id'            => 'sidebar-content-home',
		'description'   => __( 'Additional sidebar that appears on the content.', 'times-square' ),
		'before_widget' => '<aside class="col-md-4">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2>',
